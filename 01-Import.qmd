...
2. Webscraping footballcritic to extract unique match_id in a particular season for each premier league team. For this the season_id was unique and was the 'slug' which has the season name and team names. Here is an example url https://www.footballcritic.com/premier-league/season-2024-2025/matches/2/72764. A big problem with footballcritic is that before 2023/24 season, the player ratings don't exist. Therefore I was limited to just the last two seasons. Initially the plan was to have 6 seasons worth of data.
