...
The predictive model made was with respect to player evaluation and could be extended to player acquisition. The idea is discussed below:
...
More details about the model are found here: [Model](04-Model.qmd)
