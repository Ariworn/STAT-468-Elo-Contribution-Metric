...
Next I create a dictionary for team_ids with the starting elo I took from clubelo's website such that 475 = 1877 for instance. Then I generate the elo for each match pre and post result.
